    ...
    <div className='w-screen h-full overflow-x-hidden pt-20'>
      ...
      <div className='lg:flex lg:flex-row lg:items-center lg:px-20'>
        ...
        <div className='lg:flex lg:flex-col lg:flex-1'>
          ...
          <div className={`${roboto.className} flex flex-col justify-start px-5`}>
            <h1 className={`${raleway.className} text-lg font-light lg:text-2xl lg:font-semibold`}>{"Über micht"}</h1>
            <p className='font-light leading-7 lg:text-xl lg:font-light lg:text-[#323335]'>
            ...
            <p className='font-light leading-7 mt-5 lg:text-xl lg:font-light lg:text-[#323335]'>
        ...
        <div className='lg:flex lg:flex-col lg:flex-1'>
          ...
          <div className={`${roboto.className} px-5`}>
            <h1 className={`${raleway.className} text-lg font-light lg:text-2xl lg:font-semibold`}>{"Berufserfahrung"}</h1>
            <li className='font-light leading-6 mt-5 ml-5 lg:text-xl lg:font-light lg:text-[#323335]'>
            ...
            <li className='font-light leading-6 mt-5 ml-5 lg:text-xl lg:font-light lg:text-[#323335]'>{"seit 2013 Sozialarbeiter & Berater in einer Psychosozialen Kontakt- und Beratungstelle in Berlin-Mitte"}</li>
            <li className='font-light leading-6 mt-5 ml-5 lg:text-xl lg:font-light lg:text-[#323335]'>{"2010 bis 2012 Sozialarbeiter im Betreuten Wohnen für Alkoholabhängige in Berlin-Kreuzberg"}</li>
            ...
            <li className='font-light leading-6 mt-5 ml-5 lg:text-xl lg:font-light lg:text-[#323335]'>{"2011 bis 2012 Weiterbildung Psychosoziale Beratung/Counseling an der"}
      ...
      <div className='bg-[#A0A0A0] h-full pb-20 lg:pb-0 my-20 lg:flex'>
        ...
        <div className='px-5 py-5 lg:flex lg:flex-col lg:flex-1 lg:justify-center'>
          <h1 className={`${raleway.className} text-white text-xl text-left lg:w-1/2 lg:text-xl lg:font-semibold lg:ml-10`}>{"Sich auf den Weg machen"}</h1>
          <p className={`${roboto.className} text-white leading-7 font-light lg:w-3/4 lg:text-xl lg:ml-10`}>
