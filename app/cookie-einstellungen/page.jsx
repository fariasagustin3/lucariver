...
const Page = () => {
  ...
  return (
    <div className=''>
      <Navbar />
      <div className='flex flex-col px-10 lg:px-80 mt-14 pt-20 lg:py-32'>
        <div>
          <h1 className={`${raleway.className} text-lg lg:text-3xl font-light`}>{"Cookie-Richtlinie"}</h1>
          <p className={`${roboto.className} text-base lg:text-lg font-light`}>
        ...
        <div className='mb-10'>
          <h1 className={`${raleway.className} text-lg lg:text-3xl font-light`}>{"Unbedingt erforderlich"}</h1>
          <p className={`${roboto.className} text-base lg:text-lg font-light`}>
        ...
        <div className='bg-[#F9F9F9] px-5'>
          ...
          <div className='flex flex-row items-center my-5 gap-5 underline lg:flex-col lg:items-start lg:ml-10'>
        ...
        <div>
          <h1 className={`${raleway.className} text-lg lg:text-3xl font-light my-10`}>{"Funktionell"}</h1>
          <p className={`${roboto.className} text-base lg:text-lg font-light my-10`}>
        ...
        <div>
          <h1 className={`${raleway.className} text-lg lg:text-3xl font-light my-10`}>{"Marketing / Third Party"}</h1>
          <p className={`${roboto.className} text-base lg:text-lg font-light my-10`}>
        ...
        <div>
          <h1 className={`${raleway.className} text-lg lg:text-3xl font-light my-10`}>{"Performance"}</h1>
          <p className={`${roboto.className} text-base lg:text-lg font-light my-10`}>
        ...
        <div className='bg-[#F9F9F9] px-5'>
          ...
          <div className='flex flex-row items-center gap-5 py-5 lg:flex-col lg:items-start underline lg:ml-10'>
